 ...
 */
public interface BASESTATIONDAOIF {
	
	
	/**
	 * 
	 */
	public static final String  RETRIVE_NODEIDS_WHO_ARE_ZONE_LEADERS_SQUARE_BS_TOPOLOGY="RETRIVE_NODEIDS_WHO_ARE_ZONE_LEADERS_SQUARE_BS_TOPOLOGY";
	/**
	 * 
	 */
	public static final String RETRIVE_NODEIDS_DETAILS_FOR_ZONEID_SQUARETOPOLOGY_BS="RETRIVE_NODEIDS_DETAILS_FOR_ZONEID_SQUARETOPOLOGY_BS";
	/**
	 * 
	 */
	public static final String UPDATE_ZONELEADER_FORNODEID_SQUARETOPOLOGY_BS="UPDATE_ZONELEADER_FORNODEID_SQUARETOPOLOGY_BS";
	/**
	 * 
	 */
	public static final String RETRIVE_ZONEIDSQUARETOPOLOGY_BS="RETRIVE_ZONEIDSQUARETOPOLOGY_BS";
	/**
	 * 
	 */
	public static final String UPDATE_SQUAREZONETOPOLOGY_BS_QUERY="UPDATE_SQUAREZONETOPOLOGY_BS_QUERY";
	/**
	 * 
	 */
	public static final String DELETE_SQUAREZONETOPOLOGY_BS__QUERY="DELETE_SQUAREZONETOPOLOGY_BS__QUERY";
	
	/**
	 * 
	 */
	public static final String INSERT_SQUAREZONETOPOLOGY_BS_QUERY="INSERT_SQUAREZONETOPOLOGY_BS_QUERY";
	
	/**
	 * 
	 */
	public static final String  RETRIVE_SQUARETOPOLOGY_BS_QUERY="RETRIVE_SQUARETOPOLOGY_BS_QUERY";
