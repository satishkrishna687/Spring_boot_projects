...
public class GradeRouteCriteria {

	private int forwardNodeEliminateValues;
	...
	/**
	 * @param forwardNodeEliminateValues
	 */
	public void setForwardNodeEliminateValues(int forwardNodeEliminateValues) {
		this.forwardNodeEliminateValues = forwardNodeEliminateValues;
	}

	/**
	 * @return Eliminate Forward Node Pick Values
	 */
	public int getForwardNodeEliminateValues() {
		return forwardNodeEliminateValues;
	}
