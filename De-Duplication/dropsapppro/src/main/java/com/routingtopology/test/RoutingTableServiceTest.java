...
public class RoutingTableServiceTest {
	...
	public static void main(String[] args) {
		...
		RoutingTableServiceIF routingServiceIF = (RoutingTableServiceIF) context
				.getBean("routingTableService");
		// createRoutingTables(TopologyTypesIF.RANDOM_TOPOLOGY, routingServiceIF);
		// showTopology(topologyServiceIF);
		deleteRoutingTables(TopologyTypesIF.RANDOM_TOPOLOGY, routingServiceIF);
		// updateTopology(TopologyTypesIF.LINEAR_TOPOLOGY,routingServiceIF);

		// routingServiceIF.insertRoutingTable(TopologyTypesIF.RANDOM_TOPOLOGY);

	}

	private static void deleteRoutingTables(String linearTopology,
			RoutingTableServiceIF routingServiceIF) {

		routingServiceIF.dropTable(linearTopology);
	}

	private static void createRoutingTables(String linearTopology, RoutingTableServiceIF routingServiceIF) {

		routingServiceIF.createTable(TopologyTypesIF.RANDOM_TOPOLOGY);
	}
