...
public class SquareTopologyTestLEEACH {
	...
	private static void updateTopology(
		...
		boolean test = topologyServiceIF
				.updateSquareTopologyLEEACH(topologyInfoValueList);
	...
	private static void deleteTopology(
		...
		boolean v = topologyServiceIF.deleteSquareTopologyLEEACH();
	...
	private static void showTopology(TopologyRoutingServiceIF topologyServiceIF) {
		List<TopologyInfoValue> topologyList = topologyServiceIF
				.retriveSquareTopologyForViewLEEACH();
	...
	private static void createTopology(
		...
		angularCriteriaModel.setNoOfNodes(20);
		angularCriteriaModel.setTrustLevel(5);
		
		angularCriteriaModel.setNoOfZones(4);
		...
		boolean hel = topologyServiceIF
				.generateSquareTopologyAndStoreLEEACH(mapToCriteriaSquareModelValue(angularCriteriaModel));
