...
<script type="text/javascript" src="<%=request.getContextPath()%>/cloudsimcustom/viewallsecuritybytesgraph.js"></script>


</head>
<body>
<jsp:include page="/WEB-INF/jsp/adminmenu.jsp"></jsp:include>
<h1>Data Fragmentation and Replication Bytes</h1>
<div id="content">
