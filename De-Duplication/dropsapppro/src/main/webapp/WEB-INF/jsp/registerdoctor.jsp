...
<head>
	...
	var app_name_registered='<%=Messages.Keys.APP_NAME%>';
	   ...
	   <script src="<%=request.getContextPath()%>/js/registerdoctor.js"></script>
...
<div class="container" ng-app="registerDoctorApp" id="contentContainer">
 ...
 <div class="panel panel-primary">
    ...
    <div ng-controller="registerDoctorController" class="main-content-wrapper">
		...
		<!-- Start of Row -->
		 ...
		 <div class="row"> <!-- Start of 2nd Row -->
            ...
            <div class="col-lg-4 col-md-4 col-xs-12  col-sm-12">
					...
					<div class="form-group">
                    <label for="companyName">Hospital/Clinic Doctor:</label>
            ...
            <div class="col-lg-4 col-md-4 col-xs-12  col-sm-12">
					...
					<div class="form-group">
                    <label for="description">Hospital/Clinic Description:</label>
		...
		<div class="row"><!-- Start of 5th Row -->
			...
			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
				<button type="submit" class="productBtn" ng-click="register_serviceprovider()">Register Doctor</button>
			</div>
