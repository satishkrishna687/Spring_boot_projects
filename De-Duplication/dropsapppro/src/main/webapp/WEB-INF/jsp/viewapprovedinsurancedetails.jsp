...
<script type="text/javascript" src="<%=request.getContextPath()%>/customjs/viewapprovedinsurancedetails.js"></script>
...
<body>
<jsp:include page="/WEB-INF/jsp/insurancemenu.jsp"></jsp:include>
