...
<script type="text/javascript" src="<%=request.getContextPath()%>/cloudsimcustom/viewtopologygen.js"></script>
...
<div id="formatsGridContainer"></div>
</div>
</div>
</body>
</html>