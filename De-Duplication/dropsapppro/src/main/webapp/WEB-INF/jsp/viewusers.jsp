...
<script type="text/javascript">
	var register_end_point='<%=Messages.EndPoints.USERS_FETCH_ENDPOINT_WITH_APPNAME%>';
	var app_name_registered='<%=Messages.Keys.APP_NAME%>';
	</script>

<script src="<%=request.getContextPath()%>/cloudsimcustom/viewusers.js"></script>
...
<jsp:include page="/WEB-INF/jsp/adminmenu.jsp"></jsp:include>
	...
	<div class="container" ng-app="viewUsersApp"
		ng-controller="viewUsersController" id="contentContainer">
		...
		<div class="alert alert-info">
			<strong>Info!</strong> View Users
		</div>

		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm=12 col-xs-12">
				<div kendo-grid k-options="viewUsersOptions" />
			</div>
		</div>
