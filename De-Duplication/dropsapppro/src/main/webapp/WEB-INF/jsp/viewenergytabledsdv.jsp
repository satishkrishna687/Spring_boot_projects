...
<script type="text/javascript" src="<%=request.getContextPath()%>/cloudsimcustom/viewenergytabledsdv.js"></script>
...
<div id="menuspace">
<h1>This is the page where we view Energy Table</h1>
 </div>
