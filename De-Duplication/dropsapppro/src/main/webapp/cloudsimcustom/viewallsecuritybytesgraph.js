	   ...
	   axes: [
	          {
	              ...
	              type: 'Numeric',
	              position: 'left',
	              fields: ['encBytesClosenessCentrality','encBytesBetweenCentrality','encBytesECentrality','encBytesOptimized']
	      ...
	      series: [
	               {
	                   type: 'line',
	                   xField: 'iterationNo',
	                   yField: 'encBytesOptimized',
	                   title:'Optimized Centrality'
	               },
	               {
	                   type: 'line',
	                   xField: 'iterationNo',
	                   yField: 'encBytesECentrality',
	                   title:'E Centrality'
	               },
	               {
	                   type: 'line',
	                   xField: 'iterationNo',
	                   yField: 'encBytesClosenessCentrality',
	                   title:'Closeness Centrality'
	               },
	               {
	                   type: 'line',
	                   xField: 'iterationNo',
	                   yField: 'encBytesBetweenCentrality',
