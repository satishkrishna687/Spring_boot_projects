...
Ext.onReady(function () {
	...
	Ext.define('energyCompareModel', {
		...
		fields : [ 
		           ...
		           {name:'routeno', mapping:'userinforoutesession.routeno',type:'int'},
		           {name:'sessionid', mapping:'userinforoutesession.sessionid',type:'string'},
		           {name:'routeinstrformat', mapping:'userinforoutesession.routeinstrformat',type:'string'},
		           {name:'algorithmtype', mapping:'userinforoutesession.algorithmtype',type:'string'},
	...
	var energyCompareStoreAlgo1Store = Ext.create('Ext.data.Store', {
		...
		proxy : {
			type : 'ajax',
			url :contextPath+'/retriveAllSpecificFiles',
			actionMethods:{
				read:'POST'
			},
			reader : {
