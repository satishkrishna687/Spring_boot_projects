...
Ext.onReady(function () {
	...
	var contentPanel = Ext.create('Ext.container.Container', {
		...
		items:[
				{
					xtype:'button',
					text: 'Insert Energy Tables',
					id: 'Save',
					disabled: false,
			        handler: function (store,btn, args) {
							urlLink=contextPath+'/searp/insertenergytablesedf.do';
							hideConfirmationMsg();
							insertEnergyRequest(urlLink);
			            }
				}],
		renderTo:'contentDiv'
    });
	
	function insertEnergyRequest(urlLink)
	{
