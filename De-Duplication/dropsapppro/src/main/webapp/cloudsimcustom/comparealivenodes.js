...
var energyColumns1=[
         			{
         			 ...
         			 {
         				header : 'Alive Nodes For Energy',
         				dataIndex : 'noOfAliveNodes',
         				sortable:true,
         				width    :258
         			}
         	    		];
...
Ext.onReady(function () {
   Ext.define('energyCompareModel', {
				...
				fields : [ 
				           ...
				           {name:'noOfAliveNodes', mapping:'noOfAliveNodes',type:'int'}
						  ],
	...
	var energyCompareStoreAlgo1Store = Ext.create('Ext.data.Store', {
				...
				proxy : {
					type : 'ajax',
					url :contextPath+'/searp/retriveAliveNodesForGradeDiffusion.do',
					actionMethods:{
						read:'POST'
					},
					reader : {
	...
	var energyGridPanelAlgo1 = Ext.create('Ext.grid.Panel', {
		collapsible : true,
		title:'Number of Alive Nodes for Energy Based Routing',
		id : 'topologyGrid1',
	...
	var energyCompareStoreAlgo2Store = Ext.create('Ext.data.Store', {
		...
		proxy : {
			type : 'ajax',
			url :contextPath+'/searp/retriveAliveNodesForFaultNode.do',
			actionMethods:{
				read:'POST'
			},
			reader : {
...
id : 'topologyGrid2',
title:'Number of Alive Nodes for Flood Based Routing',
