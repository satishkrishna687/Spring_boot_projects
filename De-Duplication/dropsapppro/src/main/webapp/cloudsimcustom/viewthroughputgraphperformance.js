	   ...
	   axes: [
	          {
	              ...
	              type: 'Numeric',
	              position: 'left',
	              fields: ['optimizedThroughput','eCentralityThroughput','closenessThroughput','betweenThroughput']
	      ...
	      series: [
	               {
	                   type: 'line',
	                   xField: 'iterationNo',
	                   yField: 'optimizedThroughput',
	                   title:'Optimized Centrality'
	               },
	               {
	                   type: 'line',
	                   xField: 'iterationNo',
	                   yField: 'eCentralityThroughput',
	                   title:'E Centrality'
	               },
	               {
	                   type: 'line',
	                   xField: 'iterationNo',
	                   yField: 'closenessThroughput',
	                   title:'Closeness Centrality'
	               },
	               {
	                   type: 'line',
	                   xField: 'iterationNo',
	                   yField: 'betweenThroughput',
